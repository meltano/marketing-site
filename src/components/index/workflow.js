          ...
          {data.workflowArray.map((workflow, index) => (
            <div key={workflow.workflowTitle}>
                              ...
                              workflow.workflowUiVideo?.mediaItemUrl && (
                                <div>
                                  <video
                                    ...
                                    loop
                                    muted
                                    data-autoplay-disabled="true"
                                    controls={!!controlsVisible[index]}
                                    playsInline
                                    preload="auto"
                                    aria-label={
                                      workflow.workflowUiVideo.title ||
                                  ...
                                  >
                                    <track
                                      kind="captions"
                                      src="/assets/placeholder-captions.vtt"
                                      srcLang="en"
              ...
              <div className="workflow-separator">
                <img
                  src={separators[index]}
                  alt=""
                  width={
                    separators[index] === DashBreak1
                      ? 617
                      : separators[index] === DashBreak2
                        ? 600
                        : 593
                  }
                  height={
