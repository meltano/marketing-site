...
import { getDpaData } from "@/lib/wp/site-pages";

type PageProps = {
  data: Awaited<ReturnType<typeof getDpaData>>;
};

export default function DataProcessingAddendumPage({ data }: PageProps) {
  const { metadata, featuredImage, themePicker, content } = data.dpa.nodes[0] as {
